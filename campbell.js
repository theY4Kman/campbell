...
(function() {
  var $distilled_editor, $initial_editor, changeOccurred, imSatisfied, initialModified, initial_id_prefix, newDistilledParagraph, newInitialParagraph, newReplacementParagraph, paragraph_counter, recordCurrentState, replacementModified, reprState, resizeInitial, timeline;
  ...
  recordCurrentState = function() {
    return timeline[timeline.length - 1] = [Date.now(), reprState()];
  };

  changeOccurred = function() {
    recordCurrentState();
    return localStorage.timeline = timeline;
  };
